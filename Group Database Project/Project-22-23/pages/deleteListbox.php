...
<?php
	...
	$sql = "SELECT counterStockID, description, costPrice, quantity, supplierName	
			FROM CounterStock 
	...
	{	//store data in variables
		...
		$allText = "$id+$description+$costPrice+$quantityInStock+$supplier";	//concatanate data to string	
